 ...
 *  Date: 2018-04-26 v3.6 Modified for Hubitat
 ...
 *  Date: 2017-05-25 v3.3 Added support for Air Conditioners which have a mandatory swing field for all Commands and corrected issues with v3.2
 *  Date: 2017-05-20 v3.2 Added support for Air Conditioners which have a mandatory swing field in the heating & cool Commands, thanks again to @Jnick
...
metadata {
    ...
    standardTile("thermostatMode", "device.thermostatMode", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true) {
      state("heat", label:'HEAT', backgroundColor:"#ea2a2a", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/heat_mode_icon.png")
      state("emergency heat", label:'HEAT', backgroundColor:"#ea2a2a", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/heat_mode_icon.png")
      state("cool", label:'COOL', backgroundColor:"#089afb", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/cool_mode_icon.png")
      state("dry", label:'DRY', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/dry_mode_icon.png")
      state("fan", label:'FAN', backgroundColor:"#ffffff", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_mode_icononly.png")
      state("auto", label:'AUTO', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/auto_mode_icon.png")
      state("off", label:'', backgroundColor:"#ffffff", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_off.png", defaultState: true)
		}
    ...
    valueTile("coolingSetpoint", "device.coolingSetpoint", width: 2, height: 1, decoration: "flat") {
      ...
      state("OFF", label:'', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_off_icon.png", defaultState: true)
      state("AUTO", label:'', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_auto_icon.png")
      state("HIGH", label:'', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_high_icon.png")
      state("MIDDLE", label:'', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_med_icon.png")
      state("LOW", label:'', icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_low_icon.png")
		}

		standardTile("setAuto", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.auto", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_auto.png"
		}
    standardTile("setDry", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"dry", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_dry.png"
		}
    standardTile("setOn", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"on", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_on.png"
		}
    standardTile("setOff", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.off", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_off.png"
		}
    standardTile("cool", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.cool", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_cool.png"
		}
    standardTile("heat", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.heat", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/hvac_heat.png"
		}
    standardTile("emergencyHeat", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.emergencyHeat", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/emergencyHeat.png"
		}
    standardTile("fan", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.fanOn", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_mode_icon.png"
		}
    standardTile("coolingSetpointUp", "device.coolingSetpoint", canChangeIcon: false, decoration: "flat") {
      state "coolingSetpointUp", label:'  ', action:"coolingSetpointUp", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/cool_arrow_up.png"
    }
		standardTile("coolingSetpointDown", "device.coolingSetpoint", canChangeIcon: false, decoration: "flat") {
      state "coolingSetpointDown", label:'  ', action:"coolingSetpointDown", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/cool_arrow_down.png"
    }
		standardTile("heatingSetpointUp", "device.heatingSetpoint", canChangeIcon: false, decoration: "flat") {
      state "heatingSetpointUp", label:'  ', action:"heatingSetpointUp", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/heat_arrow_up.png"
    }
    standardTile("heatingSetpointDown", "device.heatingSetpoint", canChangeIcon: false, decoration: "flat") {
      state "heatingSetpointDown", label:'  ', action:"heatingSetpointDown", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/heat_arrow_down.png"
    }
      ...
      state("default", label:'', action:"cmdFanSpeedAuto",  icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_auto_icon.png")
    }
    standardTile("cmdFanSpeedHigh", "device.thermostat", width: 2, height: 1, canChangeIcon: false, canChangeBackground: true, decoration: "flat") {
      state("default", label:'', action:"cmdFanSpeedHigh",  icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_high_icon.png")
    }
    standardTile("cmdFanSpeedMid", "device.thermostat", width: 2, height: 1, canChangeIcon: false, canChangeBackground: true, decoration: "flat") {
      state("default", label:'', action:"cmdFanSpeedMid",  icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_med_icon.png")
    }
    standardTile("cmdFanSpeedLow", "device.thermostat", width: 2, height: 1, canChangeIcon: false, canChangeBackground: true, decoration: "flat") {
      state("default", label:'', action:"cmdFanSpeedLow",  icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/fan_low_icon.png")
    }
      ...
      state("default", label:'', action:"endManualControl", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-cooling-thermostat.src/Images/endManual.png")
		}
