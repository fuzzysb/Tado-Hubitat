 ...
 *	Date: 2018-04-26 v2.0 Modified for Hubitat
...
tiles(scale: 2){
      	multiAttributeTile(name: "thermostat", type:"thermostat", width:6, height:4) {
			tileAttribute("device.temperature", key:"PRIMARY_CONTROL", canChangeIcon: true, canChangeBackground: true){
            	attributeState "default", label:'${currentValue}°', backgroundColor:"#fab907", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/tap_icon.png"
            }
        ...
        standardTile("tadoMode", "device.tadoMode", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true) {
            ...
            state("OFF", label:'', backgroundColor:"#ffffff", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/hvac_off.png", defaultState: true)
		...
		standardTile("thermostatMode", "device.thermostatMode", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true) {
        	state("heat", label:'HEAT', backgroundColor:"#ea2a2a", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/heat_mode_icon.png")
            state("off", label:'', backgroundColor:"#ffffff", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/hvac_off.png", defaultState: true)
		}
        ...
        standardTile("Off", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.off", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/hvac_off.png"
		}
		standardTile("emergencyHeat", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.emergencyHeat", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/emergencyHeat.png"
		}
		...
		standardTile("heat", "device.thermostat", width: 2, height: 1, decoration: "flat") {
			state "default", label:"", action:"thermostat.heat", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/hvac_heat.png"
		}
		standardTile("heatingSetpointUp", "device.heatingSetpoint", width: 1, height: 1, canChangeIcon: false, decoration: "flat") {
            state "heatingSetpointUp", label:'', action:"heatingSetpointUp", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/heat_arrow_up.png"
        }
        standardTile("heatingSetpointDown", "device.heatingSetpoint", width: 1, height: 1, canChangeIcon: false, decoration: "flat") {
            state "heatingSetpointDown", label:'', action:"heatingSetpointDown", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/heat_arrow_down.png"
        }
		standardTile("endManualControl", "device.thermostat", width: 2, height: 1, canChangeIcon: false, canChangeBackground: true, decoration: "flat") {
            state("default", label:'', action:"endManualControl", icon:"https://raw.githubusercontent.com/fuzzysb/Tado-Hubitat/master/devicetypes/fuzzysb/tado-hot-water-control.src/Images/endManual.png")
		}
		main "thermostat"
